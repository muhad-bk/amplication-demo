...
@InputType()
class AuthenticationStrategyCreateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () =>
      UserAuthenticationStrategyCreateNestedManyWithoutAuthenticationStrategiesInput,
  })
  @ValidateNested()
  @Type(
    () =>
...
export { AuthenticationStrategyCreateInput };
