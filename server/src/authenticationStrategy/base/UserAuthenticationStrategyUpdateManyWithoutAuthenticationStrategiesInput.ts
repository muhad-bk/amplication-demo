...
@InputType()
class UserAuthenticationStrategyUpdateManyWithoutAuthenticationStrategiesInput {
...
export { UserAuthenticationStrategyUpdateManyWithoutAuthenticationStrategiesInput };
